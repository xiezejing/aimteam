<template>
  <a-layout  id="components-layout-demo-side" style="min-height: 100vh;">
    ...
    <a-layout>
      <a-layout-content id="main-panel" style="margin: 0;background: '#fff'; min-height: '360px'">
          <AimTabs :style="{ padding: '10px', background: '#fff', minHeight: '100%'}"/>
...
import AimTabs from './components/AimTabs.vue'
